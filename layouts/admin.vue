                                                        ...
                                                        <DisclosureButton
                                                            :class="[
                                                                item.current
                                                                    ? 'bg-gray-800 text-white'
                                                                    : 'text-gray-400 hover:text-white hover:bg-gray-800',
                                                                'group flex items-center w-full text-left rounded-md p-2 gap-x-3 text-sm leading-6 font-semibold text-gray-400',
                                                            ]"
                                                        >
                                                            <component
                                                                :is="item.icon"
                                    ...
                                    <a
                                        ...
                                        :class="[
                                            item.current
                                                ? 'bg-gray-800 text-white'
                                                : 'text-gray-400 hover:text-white hover:bg-gray-800',
                                            'cursor-pointer first-line:group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold',
                                        ]"
                                    >
                                        <component
                                            :is="item.icon"
...
import { ChartBarIcon, ChevronRightIcon } from "@heroicons/vue/20/solid";
import {
    ChevronDownIcon,
    MagnifyingGlassIcon,
...
const navigation = [
    ...
    { name: "Services", href: "/services", icon: TruckIcon, current: false },
    {
        name: "Contact",
        href: "/contact",
    ...
    { name: "Sales", href: "/sales", icon: ChartBarSquareIcon, current: false },
